...
preJob.preInitDB.enabled | 是否初始数据库
preJob.preInitDB.datasource.url | 数据库连接地址
preJob.preInitDB.datasource.username | 数据库用户名
preJob.preInitDB.datasource.password | 数据库密码
